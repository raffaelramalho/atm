      ...
      <div className='h-full w-full'>
        ...
        <div className={`flex flex-col mb-5 w-full  rounded-md overflow-y-auto h-3/4`}>
          {log.length > 0 ? (
            log.map((entry, index) => (
              <div
                className={`flex flex-row w-full h-32 items-center justify-between px-5 transition ${index % 2 === 0 ? 'bg-background hover:bg-[#426983] hover:text-[#fff]' : 'bg-[#dfdfdf] hover:bg-[#a1a1a1]'} first:rounded-md last:rounded-b-sm`}
              >
